...
void Impl::ParseAttributes(const std::string& attributesStr, Node& node)
{
    ...
    {
        size_t attributeNameEndPos = attributesStr.find(Impl::Constants::EQUALS_SIGN, attributeOffset);
        std::string attributeName = attributesStr.substr(attributeOffset, attributeNameEndPos);
